...
{
   /// <summary>
   /// converts between a Slovenia national account number and the Slovenia IBAN
   /// SIkk BBSS SCCC CCCC CKK
   /// </summary>
   public class SloveniaIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,2}{1,3}{2,10}281800"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,2}{3,3}{4,10}"; } }

      /// <summary>
      /// Gets the length of the IBAN.
      /// </summary>
      protected override int IBANLength { get { return 19; } }
      ...
      {
         return cleanIBAN.Substring(6, 3).TrimStart('0');
      }
      ...
      {
         return cleanIBAN.Substring(9, 10).TrimStart('0');
      }
      ...
      {
         return other == null ? new SloveniaAccountNumber() : new SloveniaAccountNumber(other);
      }
   }
}
