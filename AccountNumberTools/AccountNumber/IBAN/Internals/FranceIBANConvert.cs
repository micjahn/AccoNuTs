...
{
   /// <summary>
   /// converts between a France national account number and the France IBAN
   /// FRkk BBBB BGGG GGCC CCCC CCCC CKK
   /// </summary>
   public class FranceIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "FR";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,5}{1,5}{2,13}152700"; } }
      ...
      {
         return other == null ? new FranceAccountNumber() : new FranceAccountNumber(other);
      }
   }
}
