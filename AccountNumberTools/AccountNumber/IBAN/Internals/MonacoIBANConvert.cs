...
{
   /// <summary>
   /// converts between a Monaco national account number and the Monaco IBAN
   /// MCkk BBBB BGGG GGCC CCCC CCCC CKK
   /// </summary>
   public class MonacoIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,5}{1,5}{2,13}221200"; } }
      ...
      {
         return other == null ? new MonacoAccountNumber() : new MonacoAccountNumber(other);
      }
   }
}
