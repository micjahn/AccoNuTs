...
{
   /// <summary>
   /// converts between a Bosnia And Herzegovina national account number and the Bosnia And Herzegovina IBAN
   /// BAkk BBBS SSCC CCCC CCKK
   /// </summary>
   public class BosniaAndHerzegovinaIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,3}{2,10}111000"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,3}{3,3}{4,10}"; } }
      ...
      {
         return cleanIBAN.Substring(10, 10).TrimStart('0');
      }
