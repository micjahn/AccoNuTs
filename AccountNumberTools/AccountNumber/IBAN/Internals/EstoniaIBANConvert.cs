...
{
   /// <summary>
   /// converts between a Estonia national account number and the Estonia IBAN
   /// EEkk BBSS CCCC CCCC CCCK
   /// </summary>
   public class EstoniaIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "EE";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,2}{1,2}{2,12}141400"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,2}{3,2}{4,12}"; } }
      ...
      {
         return cleanIBAN.Substring(6, 2).TrimStart('0');
      }
      ...
      {
         return cleanIBAN.Substring(8, 12).TrimStart('0');
      }
      ...
      {
         return other == null ? new EstoniaAccountNumber() : new EstoniaAccountNumber(other);
      }
   }
}
