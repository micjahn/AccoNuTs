...
{
   /// <summary>
   /// converts between a Ireland national account number and the Ireland IBAN
   /// IEkk AAAA BBBB BBCC CCCC CC
   /// </summary>
   public class IrelandIBANConvert : AccountBICAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "IE";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,6}{2,8}181400"; } }
      ...
      {
         return other == null ? new IrelandAccountNumber() : new IrelandAccountNumber(other);
      }
   }
}
