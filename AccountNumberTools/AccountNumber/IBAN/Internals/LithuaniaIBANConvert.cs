...
namespace AccountNumberTools.AccountNumber.IBAN.Internals
{
   ...
   public class LithuaniaIBANConvert : AccountAndBankCodeIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,5}{1,11}212900"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,5}{3,11}"; } }
      ...
      {
         return cleanIBAN.Substring(9, 11).TrimStart('0');
      }
      ...
      {
         return other == null ? new LithuaniaAccountNumber() : new LithuaniaAccountNumber(other);
      }
   }
}
