...
{
   /// <summary>
   /// converts between a Greece national account number and the Greece IBAN
   /// GRkk BBBS SSSC CCCC CCCC CCCC CCC
   /// </summary>
   public class GreeceIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "GR";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,4}{2,16}162700"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,3}{3,4}{4,16}"; } }
      ...
      {
         return cleanIBAN.Substring(11, 16).TrimStart('0');
      }
      ...
      {
         return other == null ? new GreeceAccountNumber() : new GreeceAccountNumber(other);
      }
   }
}
