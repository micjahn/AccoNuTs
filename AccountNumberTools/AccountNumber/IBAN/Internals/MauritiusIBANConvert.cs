...
{
   /// <summary>
   /// converts between a Mauritius national account number and the Mauritius IBAN
   /// MUkk BBBB BBSS CCCC CCCC CCCC CCCC CC
   /// </summary>
   public class MauritiusIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "MU";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,6}{1,2}{2,18}223000"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,6}{3,2}{4,18}"; } }
      ...
      {
         return cleanIBAN.Substring(10, 2).TrimStart('0');
      }
      ...
      {
         return cleanIBAN.Substring(12, 18).TrimStart('0');
      }
      ...
      {
         return other == null ? new MauritiusAccountNumber() : new MauritiusAccountNumber(other);
      }
   }
}
