...
namespace AccountNumberTools.AccountNumber.Internals
{
   ...
   /// </summary>
   internal class BankCodeMapToValidationMethodDummy : IBankCodeMapToValidationMethodCode
   {
      private static IBankCodeMapToValidationMethodCode instance;

      internal static IBankCodeMapToValidationMethodCode Instance
      { 
         get
         {
            // no lock, it doesn't matter
            return instance ?? (instance = new BankCodeMapToValidationMethodDummy());
         }
      }
