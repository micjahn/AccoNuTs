...
{
   internal class ValidationMethod08 : ValidationMethodModuloBase
   {
      /// <summary>
      /// Initializes a new instance of the <see cref="ValidationMethod08"/> class.
      /// </summary>
      public ValidationMethod08()
      {
         WeightMask = "21";
         Modulo = 10;
      }
