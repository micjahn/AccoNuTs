...
{
   /// <summary>
   /// converts between a Mauritania national account number and the Mauritania IBAN
   /// MRkk BBBB BGGG GGCC CCCC CCCC CKK
   /// </summary>
   public class MauritaniaIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,5}{1,5}{2,13}222700"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,5}{3,5}{4,13}"; } }
      ...
      {
         return cleanIBAN.Substring(9, 5).TrimStart('0');
      }
      ...
      {
         return cleanIBAN.Substring(14, 13).TrimStart('0');
      }
      ...
      {
         return other == null ? new MauritaniaAccountNumber() : new MauritaniaAccountNumber(other);
      }
   }
}
