...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class DenmarkIBANConvert : AccountAndBankCodeIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,10}132000"; } }
      ...
      {
         return other == null ? new DenmarkAccountNumber() : new DenmarkAccountNumber(other);
      }
   }
}
