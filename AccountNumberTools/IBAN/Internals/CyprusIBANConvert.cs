...
{
   /// <summary>
   /// converts between a Cyprus national account number and the Cyprus IBAN
   /// CYkk BBBS SSSS CCCC CCCC CCCC CCCC
   /// </summary>
   public class CyprusIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "CY";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,5}{2,16}123400"; } }
      ...
      {
         return other == null ? new CyprusAccountNumber() : new CyprusAccountNumber(other);
      }
   }
}
