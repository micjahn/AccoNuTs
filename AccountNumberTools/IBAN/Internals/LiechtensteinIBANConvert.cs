...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class LiechtensteinIBANConvert : AccountAndBankCodeIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,5}{1,12}211800"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,5}{3,12}"; } }
      ...
      {
         return other == null ? new LiechtensteinAccountNumber() : new LiechtensteinAccountNumber(other);
      }
   }
}
