...
{
   /// <summary>
   /// converts between a Spain national account number and the Spain IBAN
   /// ESkk BBBB GGGG KKCC CCCC CCCC
   /// </summary>
   public class SpainIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "ES";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,4}{2,12}142800"; } }
      ...
      {
         return other == null ? new SpainAccountNumber() : new SpainAccountNumber(other);
      }
   }
}
