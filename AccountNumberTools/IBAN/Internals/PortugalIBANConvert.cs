...
{
   /// <summary>
   /// converts between a Portugal national account number and the Portugal IBAN
   /// PTkk BBBB SSSS CCCC CCCC CCCK K
   /// </summary>
   public class PortugalIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,4}{2,13}252900"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,4}{4,13}"; } }

      /// <summary>
      /// Gets the length of the IBAN.
      /// </summary>
      protected override int IBANLength { get { return 25; } }
      ...
      {
         return cleanIBAN.Substring(12, 13).TrimStart('0');
      }
      ...
      {
         return other == null ? new PortugalAccountNumber() : new PortugalAccountNumber(other);
      }
   }
}
