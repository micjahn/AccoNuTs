...
{
   /// <summary>
   /// converts between a Poland national account number and the Poland IBAN
   /// PLkk BBBS SSSK CCCC CCCC CCCC CCCC
   /// </summary>
   public class PolandIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,4}{2,17}252100"; } }
      ...
      {
         return other == null ? new PolandAccountNumber() : new PolandAccountNumber(other);
      }
   }
}
