...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class GeorgiaIBANConvert : AccountAndBankCodeIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,2}{1,16}161400"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,2}{3,16}"; } }
      ...
      {
         return cleanIBAN.Substring(6, 16).TrimStart('0');
      }
      ...
      {
         return other == null ? new GeorgiaAccountNumber() : new GeorgiaAccountNumber(other);
      }
   }
}
