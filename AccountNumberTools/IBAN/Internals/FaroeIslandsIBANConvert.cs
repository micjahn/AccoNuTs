...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class FaroeIslandsIBANConvert : AccountAndBankCodeIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,10}152400"; } }
      ...
      {
         return other == null ? new FaroeIslandsAccountNumber() : new FaroeIslandsAccountNumber(other);
      }
   }
}
