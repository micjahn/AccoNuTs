...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class AustriaIBANConvert : AccountAndBankCodeNumberIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,5}{1,11}102900"; } }
      ...
      {
         return other == null ? new AustriaAccountNumber() : new AustriaAccountNumber(other);
      }
   }
}
