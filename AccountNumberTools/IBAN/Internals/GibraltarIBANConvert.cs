...
{
   /// <summary>
   /// converts between a Gibraltar national account number and the Gibraltar IBAN
   /// GIkk BBBB CCCC CCCC CCCC CCC
   /// </summary>
   public class GibraltarIBANConvert : AccountAndBICIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "GI";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,15}161800"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,15}"; } }
      ...
      {
         return cleanIBAN.Substring(8, 15).TrimStart('0');
      }
      ...
      {
         return other == null ? new GibraltarAccountNumber() : new GibraltarAccountNumber(other);
      }
   }
}
