...
{
   /// <summary>
   /// converts between a Latvia national account number and the Latvia IBAN
   /// LVkk BBBB CCCC CCCC CCCC C
   /// </summary>
   public class LatviaIBANConvert : AccountAndBICIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "LV";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,13}213100"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,13}"; } }
      ...
      {
         return cleanIBAN.Substring(8, 13).TrimStart('0');
      }
      ...
      {
         return other == null ? new LatviaAccountNumber() : new LatviaAccountNumber(other);
      }
   }
}
