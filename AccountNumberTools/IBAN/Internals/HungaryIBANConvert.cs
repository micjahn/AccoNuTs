...
{
   /// <summary>
   /// converts between a Hungary national account number and the Hungary IBAN
   /// HUkk BBBS SSSS CCCC CCCC CCCC CCCK
   /// </summary>
   public class HungaryIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,5}{2,16}173000"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,3}{3,5}{4,16}"; } }
      ...
      {
         return cleanIBAN.Substring(7, 5).TrimStart('0');
      }
      ...
      {
         return cleanIBAN.Substring(12, 16).TrimStart('0');
      }
      ...
      {
         return other == null ? new HungaryAccountNumber() : new HungaryAccountNumber(other);
      }
   }
}
