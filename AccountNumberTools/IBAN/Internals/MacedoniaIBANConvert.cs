...
{
   /// <summary>
   /// converts between a Macedonia national account number and the Macedonia IBAN
   /// MKkk BBBC CCCC CCCC CKK
   /// </summary>
   public class MacedoniaIBANConvert : AccountAndBankCodeIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "MK";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,12}222000"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,3}{3,12}"; } }
      ...
      {
         return cleanIBAN.Substring(7, 12).TrimStart('0');
      }
      ...
      {
         return other == null ? new MacedoniaAccountNumber() : new MacedoniaAccountNumber(other);
      }
   }
}
