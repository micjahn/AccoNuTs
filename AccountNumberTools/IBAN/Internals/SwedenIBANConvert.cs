...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class SwedenIBANConvert : AccountAndBankCodeNumberIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0:000}{1:00000000000000000}281400"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2:000}{3:00000000000000000}"; } }
      ...
      {
         return cleanIBAN.Substring(7, 17).TrimStart('0');
      }
      ...
      {
         return other == null ? new SwedenAccountNumber() : new SwedenAccountNumber(other);
      }
   }
}
