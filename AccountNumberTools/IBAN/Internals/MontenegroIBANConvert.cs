...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class MontenegroIBANConvert : AccountAndBankCodeNumberIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0:000}{1:000000000000000}221400"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2:000}{3:000000000000000}"; } }
      ...
      {
         return other == null ? new MontenegroAccountNumber() : new MontenegroAccountNumber(other);
      }
   }
}
