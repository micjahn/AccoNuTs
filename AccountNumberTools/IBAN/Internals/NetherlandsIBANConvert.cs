...
{
   /// <summary>
   /// converts between a Netherlands national account number and the Netherlands IBAN
   /// NLkk BBBB CCCC CCCC CC
   /// </summary>
   public class NetherlandsIBANConvert : AccountAndBICIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,10}232100"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,10}"; } }
      ...
      {
         return cleanIBAN.Substring(8, 10).TrimStart('0');
      }
      ...
      {
         return other == null ? new NetherlandsAccountNumber() : new NetherlandsAccountNumber(other);
      }
   }
}
