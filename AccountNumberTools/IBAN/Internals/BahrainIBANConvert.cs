...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class BahrainIBANConvert : AccountAndBankCodeIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,14}111000"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,14}"; } }
      ...
      {
         return cleanIBAN.Substring(8, 14).TrimStart('0');
      }
      ...
      {
         return other == null ? new BahrainAccountNumber() : new BahrainAccountNumber(other);
      }
   }
}
