...
{
   /// <summary>
   /// converts between a Romania national account number and the Romania IBAN
   /// ROkk BBBB CCCC CCCC CCCC CCCC
   /// </summary>
   public class RomaniaIBANConvert : AccountAndBICIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "RO";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,16}272400"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,16}"; } }
      ...
      {
         return cleanIBAN.Substring(8, 16).TrimStart('0');
      }
