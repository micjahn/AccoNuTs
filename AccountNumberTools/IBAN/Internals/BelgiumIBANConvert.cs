...
namespace AccountNumberTools.IBAN.Internals
{
   ...
   public class BelgiumIBANConvert : AccountAndBankCodeNumberIBANConvert
   {
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,3}{1,9}111400"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,3}{3,9}"; } }

      /// <summary>
      /// Gets the length of the IBAN.
      /// </summary>
      protected override int IBANLength { get { return 16; } }
      ...
      {
         return cleanIBAN.Substring(7, 9).TrimStart('0');
      }
