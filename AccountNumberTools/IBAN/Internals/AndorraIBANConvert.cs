...
{
   /// <summary>
   /// converts between a Andorra national account number and the Andorra IBAN
   /// ADkk BBBB SSSS CCCC CCCC CCCC
   /// </summary>
   public class AndorraIBANConvert : AccountBankCodeAndBranchIBANConvert
   {
      /// <summary>
      /// 
      /// </summary>
      public const string Prefix = "AD";
      ...
      /// </summary>
      protected override string BBANFormatString { get { return "{0,4}{1,4}{2,12}101300"; } }
      ...
      /// </summary>
      protected override string IBANFormatString { get { return "{0}{1:00}{2,4}{3,4}{4,12}"; } }
      ...
      {
         return cleanIBAN.Substring(12, 12).TrimStart('0');
      }
      ...
      {
         return other == null ? new AndorraAccountNumber() : new AndorraAccountNumber(other);
      }
   }
}
